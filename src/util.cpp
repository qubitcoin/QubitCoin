...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\QubitCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\QubitCoin
    // Mac: ~/Library/Application Support/QubitCoin
    // Unix: ~/.QubitCoin
#ifdef WIN32
    // Windows
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No QubitCoin.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override QubitCoin.conf
    ...
    if (vTimeOffsets.size() >= 5 && vTimeOffsets.size() % 2 == 1)
    {
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                {
                    fDone = true;
                    string strMessage = _("Warning: Please check that your computer's date and time are correct! If your clock is wrong QubitCoin will not work properly.");
