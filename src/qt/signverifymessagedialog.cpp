    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a QubitCoin address (e.g. GcFfATXk6NT6pDJbK8DYMUzKshE2NePU1Z)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a QubitCoin address (e.g. GcFfATXk6NT6pDJbK8DYMUzKshE2NePU1Z)"));
