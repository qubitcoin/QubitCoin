    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Qubitcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Qubitcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qubitcoin: URIs)"));
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About Qubitcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Qubitcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Qubitcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Qubitcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Qubitcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a qubitcoin: URI or payment request"));

    showHelpMessageAction = new QAction(TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Qubitcoin Core help message to get a list with possible Qubitcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Qubitcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Qubitcoin network", "", count));
}
...
{
    QString strTitle = tr("Qubitcoin"); // default title
