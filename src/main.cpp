...
// Copyright (c) 2013 The QubitCoin developers
...
uint256 hashGenesisBlock("0x0000049ce6324e2f3f17eec90ce7e1f0bc9bcb44f85d769621d83cbb223ddc03");
static const unsigned int timeGenesisBlock = 1389361954;
...
*/
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x78c3da5dcd0861c15a0ccaa32e9afed39afca2c5b45a2250876776ed4ea4c227"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("QubitCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("QubitCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("QubitCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("QubitCoin-miner");
    ...
    try { loop {
        ...
        printf("Running QubitCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("QubitCoinMiner terminated\n");
        throw;
    }
}
